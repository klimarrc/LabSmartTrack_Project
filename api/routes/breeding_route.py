...
from blueprints.breeding import all_rooms, breeding_pairs_from_session, filtered_animals, litters_from_session, pi_strain_filter_options, pi_strain_summary_for_pairs, room_id_for_pair
from data.breeding import DEMO_AVAILABLE_MALES, DEMO_BREEDING_PAIRS, DEMO_LITTERS, DEMO_WAITING_FEMALES, FACILITIES
...
def breeding():
    """Render the breeding overview page."""
...
def add_cage_plan():
    ...
    # Add the new cage plan to the session
    saved_plans.append(
        {
            "pair_id": pair_id,
            "room_id": request.form.get("room_id", ""),
